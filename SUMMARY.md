...
* [AutoShares Web](user-guide/web-terminal/README.md)
  ...
  * [User Widgets](user-guide/web-terminal/user-widgets/README.md)
    ...
    * [Research](user-guide/web-terminal/user-widgets/research/README.md)
      * [Quote](user-guide/web-terminal/user-widgets/research/quote.md)
      * [Trade](user-guide/web-terminal/user-widgets/research/trade.md)
      * [Chart](user-guide/web-terminal/user-widgets/research/chart.md)
      * [Profile](user-guide/web-terminal/user-widgets/research/profile.md)
      * [News](user-guide/web-terminal/user-widgets/research/news.md)
      * [Filings](user-guide/web-terminal/user-widgets/research/filings.md)
      * [Corporate Events](user-guide/web-terminal/user-widgets/research/corporate-events.md)
      * [Share Info](user-guide/web-terminal/user-widgets/research/share-info.md)
      * [Key Ratios](user-guide/web-terminal/user-widgets/research/key-ratios.md)
      * [Analyst](user-guide/web-terminal/user-widgets/research/analyst.md)
      * [Earnings](user-guide/web-terminal/user-widgets/research/earnings.md)
      * [Financials](user-guide/web-terminal/user-widgets/research/financials.md)
      * [Price History](user-guide/web-terminal/user-widgets/research/price-history.md)
      * [Insiders](user-guide/web-terminal/user-widgets/research/insiders.md)
...
* [AutoShares Mobile](user-guide/etna-trader-mobile/README.md)
  ...
  * [Watchlist & Quotes View](user-guide/etna-trader-mobile/quotes-view/README.md)
    * [Trade View](user-guide/etna-trader-mobile/quotes-view/trade-view/README.md)
      * [Stock Trading](user-guide/etna-trader-mobile/quotes-view/trade-view/stock-trading.md)
      * [Options Trading](user-guide/etna-trader-mobile/quotes-view/trade-view/options-trading.md)
  * [Positions View](user-guide/etna-trader-mobile/positions-view.md)
  * [Orders View](user-guide/etna-trader-mobile/orders-view.md)
  * [Price Alerts View](user-guide/etna-trader-mobile/price-alerts-view.md)
  * [Account View](user-guide/etna-trader-mobile/account-view.md)
  * [Apple Watch Extension](user-guide/etna-trader-mobile/apple-watch-extension.md)
...
* [Trading API](web-api/trading-api/README.md)
  ...
  * [Subscriptions](web-api/trading-api/subscriptions/README.md)
    * [Bind A Phone Number To a User](web-api/trading-api/subscriptions/bind-a-phone-number-to-a-user.md)
    * [Complete Phone Number Binding](web-api/trading-api/subscriptions/complete-phone-number-binding.md)
    * [Get User's Phone Number](web-api/trading-api/subscriptions/get-users-phone-number.md)
    * [Unbind The Current Phone Number From A User](web-api/trading-api/subscriptions/unbind-the-current-phone-number-from-a-user.md)
    * [Get User's Subscription Settings](web-api/trading-api/subscriptions/get-users-subscription-settings.md)
    * [Modify User's Subscription Settings](web-api/trading-api/subscriptions/modify-users-subscription-settings.md)
    * [Assign Mobile UUID To A User](web-api/trading-api/subscriptions/assign-mobile-uuid-to-a-user.md)
    * [Remove A Mobile UUID From A User](web-api/trading-api/subscriptions/remove-a-mobile-uuid-from-a-user.md)
  ...
  * [Account Transfer](web-api/trading-api/account-transfer/README.md)
    * [Create Account Transfer Request](web-api/trading-api/account-transfer/create-account-transfer-request.md)
    * [Submit Account Transfer Request](web-api/trading-api/account-transfer/submit-account-transfer-request.md)
    * [Get User's Pending Account Transfer Requests](web-api/trading-api/account-transfer/get-users-pending-account-transfer-requests.md)
    * [Cancel Account Transfer Request](web-api/trading-api/account-transfer/cancel-account-transfer-request.md)
  ...
  * [Paperless Settings](web-api/trading-api/paperless-settings/README.md)
    * [Get Paperless Settings By Account Id](web-api/trading-api/access-settings-1/get-paperless-settings-by-account-id.md)
    * [Create Paperless Settings](web-api/trading-api/access-settings-1/create-paperless-settings.md)
    * [Update Paperless Settings By Id](web-api/trading-api/access-settings-1/update-paperless-settings-by-id.md)
    * [Create Default Paperless Settings](web-api/trading-api/access-settings-1/create-default-paperless-settings.md)
  ...
  * [Investigations](web-api/trading-api/investigations/README.md)
    ...
    * [Accept A New Appeal](web-api/trading-api/investigations/accept-a-new-appeal.md)
    * [Appeal A Rejection](web-api/trading-api/investigations/appeal-a-rejection.md)
    * [Reject A New Appeal](web-api/trading-api/investigations/reject-a-new-appeal.md)
