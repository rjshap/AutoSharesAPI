...
* [Quick Start Guide](web-api/introduction.md)
  ...
  * [Orders](api-documentation/introduction/orders/README.md)
    * [Filter Orders](api-documentation/introduction/orders/filter-orders/README.md)
    ...
    * [Get Orders](api-documentation/introduction/orders/get-orders/README.md)
    ...
    * [Place Orders(web-api/trading-api/orders/README.md)](api-documentation/introduction/orders/place-orders-web-api-trading-api-orders-readme.md/README.md)
...
* [\[Order Processing and Trading\]](api-documentation/order-processing-and-trading/README.md)
  * [Validate Order by ID](web-api/trading-api/orders/validate-order-by-id.md)
  * [\[Positions\]](api-documentation/order-processing-and-trading/positions.md)
